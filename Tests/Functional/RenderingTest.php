<?php
namespace T3v\T3vDelivery\Tests\Functional;
...
class RenderingTest extends FunctionalTestCase {
  ...
  public function templateIsRendered() {
    ...
    $expectedDom->loadHTML('<h1>T3v Delivery</h1>');
  ...
  protected function setUp() {
    ...
    $this->setUpFrontendRootPage(1, ['EXT:t3v_delivery/Tests/Functional/Fixtures/Frontend/Basic.typoscript']);
  }
